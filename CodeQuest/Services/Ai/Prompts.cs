...
public static class Prompts
{
    ...
    public static readonly string SystemGeracao = $"""
        ...
        - Para "MultiplaEscolha": 4 alternativas, distratores plausíveis baseados em ERROS COMUNS reais do conceito, e explicação de por que cada alternativa está certa/errada.
          EXATAMENTE UMA alternativa pode ter correta=true — as outras 3 são obrigatoriamente false. Se mais de uma resolver o enunciado, reescreva os distratores até sobrar uma só; a correção compara a resposta do aluno com uma única alternativa e empata em nota 0 quando há ambiguidade.
